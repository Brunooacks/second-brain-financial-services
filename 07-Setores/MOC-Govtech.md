...
# 🏛️ MOC — Govtech (Fase 2)

> Fase 2 — multissetor. Soberania pesa forte aqui.

## 🎯 Teses vivas
```dataview
TABLE status, maturidade
FROM "03-Ideas"
WHERE contains(eixos, "govtech")
...
LIST
FROM "04-Atencao"
WHERE contains(eixos, "govtech") AND status != "resolvido"
```
